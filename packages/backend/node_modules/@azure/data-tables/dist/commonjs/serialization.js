...
function serializeSignedIdentifiers(signedIdentifiers) {
    return signedIdentifiers.map((acl) => {
        ...
        const _a = accessPolicy !== null && accessPolicy !== void 0 ? accessPolicy : {}, { start, expiry } = _a, rest = tslib_1.__rest(_a, ["start", "expiry"]);
...
function deserializeSignedIdentifier(signedIdentifiers) {
    return signedIdentifiers.map((si) => {
        ...
        const _a = accessPolicy !== null && accessPolicy !== void 0 ? accessPolicy : {}, { start, expiry } = _a, restAcl = tslib_1.__rest(_a, ["start", "expiry"]);
...
function serializeQueryOptions(query) {
    const { select } = query, queryOptions = tslib_1.__rest(query, ["select"]);
