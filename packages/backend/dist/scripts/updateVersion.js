...
function updateVersion() {
    ...
    const updatedContent = existingContent.replace(/export const VERSION_INFO: VersionInfo = {[\s\S]*?};/m, `export const VERSION_INFO: VersionInfo = ${JSON.stringify(versionInfo, null, 2)};`);
    // Write back to file
