...
function updateScmAllowed() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.webApps.updateScmAllowed(resourceGroupName, name, csmPublishingAccessPoliciesEntity);
        console.log(result);
    });
}
updateScmAllowed().catch(console.error);
//# sourceMappingURL=webAppsUpdateScmAllowedSample.js.map