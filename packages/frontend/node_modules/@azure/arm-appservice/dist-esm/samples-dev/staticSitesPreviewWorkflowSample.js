...
function generatesAPreviewWorkflowFileForTheStaticSite() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.staticSites.previewWorkflow(location, staticSitesWorkflowPreviewRequest);
        console.log(result);
    });
}
generatesAPreviewWorkflowFileForTheStaticSite().catch(console.error);
//# sourceMappingURL=staticSitesPreviewWorkflowSample.js.map