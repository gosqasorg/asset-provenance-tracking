 ...
 */
function createOrUpdateAppServicePlan() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.appServicePlans.beginCreateOrUpdateAndWait(resourceGroupName, name, appServicePlan);
        console.log(result);
    });
}
createOrUpdateAppServicePlan().catch(console.error);
//# sourceMappingURL=appServicePlansCreateOrUpdateSample.js.map