...
function getAStaticSiteBuild() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.staticSites.getStaticSiteBuild(resourceGroupName, name, environmentName);
        console.log(result);
    });
}
getAStaticSiteBuild().catch(console.error);
//# sourceMappingURL=staticSitesGetStaticSiteBuildSample.js.map