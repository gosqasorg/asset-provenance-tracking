...
function getAListOfPrivateEndpointConnectionsAssociatedWithASite() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            for (var _b = __asyncValues(client.staticSites.listPrivateEndpointConnectionList(resourceGroupName, name)), _c; _c = yield _b.next(), !_c.done;) {
                let item = _c.value;
                resArray.push(item);
            }
        }
...
//# sourceMappingURL=staticSitesGetPrivateEndpointConnectionListSample.js.map