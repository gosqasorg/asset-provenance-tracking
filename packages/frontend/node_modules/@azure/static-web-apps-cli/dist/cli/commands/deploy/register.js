...
function registerCommand(program) {
    const deployCommand = program
        ...
        .option("-da, --data-api-location <path>", "the folder containing the database connections configuration", config_1.DEFAULT_CONFIG.dataApiLocation)
        ...
        .option("-al, --api-language <apiLanguage>", "the runtime language of the function/api", config_1.DEFAULT_CONFIG.apiLanguage)
        .option("-av, --api-version <apiVersion>", "the version of the function runtime language", config_1.DEFAULT_CONFIG.apiVersion)
