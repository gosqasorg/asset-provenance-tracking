...
exports.useEnvVarOrUseDefault = exports.getSwaEnvList = exports.swaCLIEnv = void 0;
/**
...
exports.swaCLIEnv = swaCLIEnv;
function getSwaEnvList() {
    const env = swaCLIEnv();
...
exports.getSwaEnvList = getSwaEnvList;
function useEnvVarOrUseDefault(env, defaultValue) {
    if (env === undefined) {
        return defaultValue;
    }
...
exports.useEnvVarOrUseDefault = useEnvVarOrUseDefault;
