...
<html lang="en">
  ...
  <body>
    ...
    <footer>
      <div>Azure Static Web Apps emulator (<a rel="noopener noreferrer" target="_blank" href="https://github.com/Azure/static-web-apps-cli/commit/e5356d2">main+sha.e5356d2</a>)</div>
      <nav>
        <ul>
