...
function FromArray(schema, references, value, cache) {
    ...
    const created = (0, index_1.IsArray)(value) ? value : (0, index_4.Create)(schema, references);
...
function FromRef(schema, references, value, cache) {
    return Visit((0, index_7.Deref)(schema, references), references, value, cache);
}
...
function FromUnion(schema, references, value, cache) {
    return (0, index_5.Check)(schema, references, value) ? (0, index_6.Clone)(value) : CastUnion(schema, references, value, cache);
}
