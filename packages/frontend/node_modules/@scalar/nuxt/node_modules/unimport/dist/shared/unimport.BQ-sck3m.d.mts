...
export { builtinPresets as e };
export type { AddonsOptions as A, BuiltinPresetName as B, DetectImportResult as D, Import as I, MagicStringResult as M, Preset as P, ScanDir as S, TypeDeclarationOptions as T, UnimportOptions as U, Unimport as a, InstallGlobalOptions as b, ScanDirExportsOptions as c, InlinePreset as d, ModuleId as f, ImportName as g, ImportCommon as h, PresetImport as i, PackagePreset as j, UnimportContext as k, InjectionUsageRecord as l, UnimportMeta as m, AddonVueDirectivesOptions as n, PathFromResolver as o, InjectImportsOptions as p, Thenable as q, Addon as r, ImportInjectionResult as s };
