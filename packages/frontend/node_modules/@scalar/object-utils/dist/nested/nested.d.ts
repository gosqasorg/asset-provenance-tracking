 ...
 *
 */
import type { ArrayKey, BrowserNativeObject, IsAny, IsEqual, IsTuple, Primitive, TupleKeys } from './common.js';
/**
 ...
 * ```
 */
type PathValue<T, P extends Path<T> | ArrayPath<T>> = T extends any ? P extends keyof T ? T[P] : P extends `${infer K}.${infer R}` ? K extends keyof T ? R extends Path<T[K]> ? PathValue<T[K], R> : never : K extends `${ArrayKey}` ? T extends ReadonlyArray<infer V> ? PathValue<V, R & Path<V>> : never : never : P extends `${ArrayKey}` ? T extends ReadonlyArray<infer V> ? V : never : never : never;
/**
 ...
 */
export declare function setNestedValue<T, P extends Path<T>>(obj: T, path: P, value: PathValue<T, P>): T;
/**
 ...
 * With Array: `'foo.1.bar'`
 */
export declare function getNestedValue<T, P extends Path<T>>(obj: T, path: P): any;
