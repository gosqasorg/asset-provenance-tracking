import { defineComponent as V, createElementBlock as l, openBlock as a, mergeProps as n, unref as t, renderSlot as A, createCommentVNode as s, createElementVNode as h } from "vue";
import { useScalarIcon as v } from "../hooks/useScalarIcon.js";
const r = { key: 0 }, d = { key: 1 }, C = { key: 2 }, L = { key: 3 }, p = { key: 4 }, u = { key: 5 }, i = {
  name: "ScalarIconRacquet"
}, f = /* @__PURE__ */ V({
  ...i,
  props: {
    label: {},
  ...
  setup(e) {
    ...
    return (M, Z) => (a(), l("svg", n({
      ...
      ]))) : t(o) === "light" ? (a(), l("g", L, Z[3] || (Z[3] = [
        h("path", { d: "M228.53,27.47C201.38.33,152.16,5.37,118.81,38.72,87.22,70.31,81.05,116.13,103.56,144L71.33,176.19l-2.1-2.11a14,14,0,0,0-19.8,0L22.1,201.41a14,14,0,0,0,0,19.8l12.69,12.7a14,14,0,0,0,19.81,0h0l27.32-27.32a14,14,0,0,0,0-19.81l-2.1-2.1L112,152.46c11.17,9,25.24,13.45,40.13,13.45,22.2,0,46.21-9.81,65.12-28.72C250.63,103.84,255.67,54.62,228.53,27.47ZM73.43,198.09,46.11,225.42a2,2,0,0,1-2.83,0L30.59,212.73a2,2,0,0,1,0-2.83l27.32-27.33a2,2,0,0,1,1.42-.58,2,2,0,0,1,1.41.58l6.35,6.34h0l6.34,6.34a2,2,0,0,1,0,2.83ZM232.34,58H198.06V23.66A46.33,46.33,0,0,1,232.34,58Zm-48.44-36c.72,0,1.44,0,2.15,0V58H150V30.57A74.84,74.84,0,0,1,183.9,21.92Zm2.15,48v36H150V70ZM127.3,47.21A93.2,93.2,0,0,1,138,38V58h-20A93.3,93.3,0,0,1,127.3,47.21ZM110.65,70H138v36h-36C101.66,94.28,104.58,81.79,110.65,70Zm-6.9,48H138v34.28A46.33,46.33,0,0,1,103.75,118Zm46.29,36V118h36v27.38C174.21,151.42,161.72,154.34,150,153.93Zm58.75-25.23a93.07,93.07,0,0,1-10.73,9.22V118H218A94.06,94.06,0,0,1,208.79,128.7ZM225.44,106H198.06V70h36C234.43,81.63,231.51,94.12,225.44,106Z" }, null, -1)
      ]))) : t(o) === "regular" ? (a(), l("g", p, Z[4] || (Z[4] = [
        h("path", { d: "M230,26.05C202-1.88,151.53,3.16,117.4,37.3c-31.79,31.79-38.33,77.77-16.51,106.49L71.33,173.35l-.68-.68a16,16,0,0,0-22.64,0L20.69,200a16,16,0,0,0,0,22.64l12.69,12.69a16,16,0,0,0,22.63,0h0L83.34,208a16,16,0,0,0,0-22.63l-.69-.69,29.56-29.56c11.29,8.58,25.24,12.79,40,12.79,22.72,0,47.25-10,66.54-29.3C252.83,104.47,257.88,54,230,26.05ZM44.7,224,32,211.31,59.33,184l6.33,6.34h0L72,196.67ZM224.23,104H200.06v-32h32A72.45,72.45,0,0,1,224.23,104ZM136,149.61A44.15,44.15,0,0,1,106.39,120H136ZM104,104a72.24,72.24,0,0,1,7.86-32H136v32Zm48-32h32v32h-32Zm77.67-16H200.06V26.28a44.23,44.23,0,0,1,29.66,29.66Zm-45.82-32h.16v32h-32V31.76A72.47,72.47,0,0,1,183.9,23.9ZM136,42.06V55.94H122.16a89.72,89.72,0,0,1,6.56-7.32A93.17,93.17,0,0,1,136,42.06Zm16,109.92V120h32v24.16A72.24,72.24,0,0,1,152.05,152Zm48-18.14V120H214a91.62,91.62,0,0,1-6.56,7.32A89.64,89.64,0,0,1,200.06,133.84Z" }, null, -1)
      ]))) : t(o) === "thin" ? (a(), l("g", u, Z[5] || (Z[5] = [
        h("path", { d: "M227.1,28.9C200.74,2.53,152.79,7.58,120.22,40.15c-31.39,31.39-37.2,77.07-14,103.94L71.33,179l-3.52-3.52a12,12,0,0,0-17,0L23.52,202.82a12,12,0,0,0,0,17l12.69,12.69a12,12,0,0,0,17,0h0L80.5,205.17a12,12,0,0,0,0-17L77,184.68l34.93-34.94c11,9.53,25.18,14.19,40.24,14.19,21.67,0,45.17-9.62,63.7-28.15C248.42,103.21,253.47,55.26,227.1,28.9ZM74.84,199.51,47.52,226.83a4,4,0,0,1-5.66,0L29.17,214.14a4,4,0,0,1,0-5.66L56.5,181.16a4,4,0,0,1,5.65,0l6.35,6.34h0l6.34,6.34a4,4,0,0,1,0,5.66ZM234.83,60H196.05V21.17A48.55,48.55,0,0,1,234.83,60ZM183.9,20c1.39,0,2.77.06,4.14.15V60H148V29.37A77.32,77.32,0,0,1,183.9,20ZM188,68v40H148V68ZM125.88,45.8A95.34,95.34,0,0,1,140,34.16V60h-25.8A94.36,94.36,0,0,1,125.88,45.8ZM109.44,68H140v40H100.17C99.33,95,102.49,81.07,109.44,68Zm-8.19,48H140v38.78A48.48,48.48,0,0,1,101.25,116ZM148,155.83V116h40v30.59C174.93,153.51,161,156.68,148,155.83Zm62.17-25.71a94.8,94.8,0,0,1-14.15,11.65V116h25.8A93.8,93.8,0,0,1,210.2,130.12ZM226.63,108H196.05V68H235.9C236.75,80.89,233.58,94.86,226.63,108Z" }, null, -1)
      ]))) : s("", !0)
    ], 16));
  }
});
