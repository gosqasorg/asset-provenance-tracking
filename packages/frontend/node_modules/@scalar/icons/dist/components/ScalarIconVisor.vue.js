import { defineComponent as c, createElementBlock as a, openBlock as o, mergeProps as i, unref as e, renderSlot as p, createCommentVNode as u, createElementVNode as n } from "vue";
import { useScalarIcon as C } from "../hooks/useScalarIcon.js";
const H = { key: 0 }, Z = { key: 1 }, m = { key: 2 }, g = { key: 3 }, h = { key: 4 }, M = { key: 5 }, f = {
  ...
  setup(r) {
    ...
    return (d, t) => (o(), a("svg", i({
      ...
      e(l) === "bold" ? (o(), a("g", H, t[0] || (t[0] = [
        ...
        n("path", { d: "M183.05,60H72A68,68,0,0,0,4.07,131.21c1.6,34.66,30,63.08,64.65,64.71,14.77.72,30-5.64,46.63-19.38a19.9,19.9,0,0,1,25.35,0C150.79,184.92,166.25,196,184,196a68,68,0,0,0,68-68.9C251.51,90.1,220.58,60,183.05,60ZM226.7,170.15A59.57,59.57,0,0,1,184,188c-15.17,0-29.07-10-38.2-17.58a27.88,27.88,0,0,0-35.55,0c-15,12.41-28.45,18.14-41.15,17.55a60.37,60.37,0,0,1-57-57.09A60,60,0,0,1,72,68H183.05c33.18,0,60.52,26.56,60.94,59.2A59.59,59.59,0,0,1,226.7,170.15ZM180,96a4,4,0,0,1-4,4H80a4,4,0,0,1,0-8h96A4,4,0,0,1,180,96Z" }, null, -1)
      ]))) : u("", !0)
    ], 16));
  }
});
