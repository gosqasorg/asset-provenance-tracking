import { defineComponent as d, createElementBlock as l, openBlock as t, mergeProps as h, unref as o, renderSlot as p, createCommentVNode as u, createElementVNode as e } from "vue";
import { useScalarIcon as V } from "../hooks/useScalarIcon.js";
const i = { key: 0 }, M = { key: 1 }, Z = { key: 2 }, L = { key: 3 }, g = { key: 4 }, m = { key: 5 }, H = {
  name: "ScalarIconPhonePlus"
}, k = /* @__PURE__ */ d({
  ...H,
  props: {
    label: {},
  ...
  setup(A) {
    const s = A, { bind: r, weight: n } = V(s);
    return (c, a) => (t(), l("svg", h({
