import { defineComponent as d, createElementBlock as l, openBlock as o, mergeProps as m, unref as a, renderSlot as p, createCommentVNode as u, createElementVNode as e } from "vue";
import { useScalarIcon as i } from "../hooks/useScalarIcon.js";
const M = { key: 0 }, g = { key: 1 }, f = { key: 2 }, h = { key: 3 }, k = { key: 4 }, w = { key: 5 }, y = {
  ...
  setup(r) {
    const Z = r, { bind: s, weight: n } = i(Z);
    return (A, t) => (o(), l("svg", m({
      ...
      a(n) === "bold" ? (o(), l("g", M, t[0] || (t[0] = [
        ...
        e("path", { d: "M174.63,81.35a80,80,0,1,0-93.28,93.28,80,80,0,1,0,93.28-93.28ZM32,96a64,64,0,1,1,64,64A64.07,64.07,0,0,1,32,96ZM160,224A63.81,63.81,0,0,1,98,176,80.07,80.07,0,0,0,176,98,64,64,0,0,1,160,224Z" }, null, -1)
      ]))) : a(n) === "fill" ? (o(), l("g", f, t[2] || (t[2] = [
        e("path", { d: "M174.63,81.35a80,80,0,1,0-93.28,93.28,80,80,0,1,0,93.28-93.28ZM96,160a64,64,0,1,1,64-64A64.07,64.07,0,0,1,96,160Z" }, null, -1)
      ]))) : a(n) === "light" ? (o(), l("g", h, t[3] || (t[3] = [
        e("path", { d: "M172.91,83.08a78,78,0,1,0-89.83,89.83,78,78,0,1,0,89.83-89.83ZM226,160a65.31,65.31,0,0,1-.62,8.9l-53.76-53.77A77.84,77.84,0,0,0,174,96c0-.17,0-.34,0-.51A65.8,65.8,0,0,1,226,160Zm-79.29-4.81,55.5,55.5A66,66,0,0,1,182.52,222l-54.8-54.81A77.86,77.86,0,0,0,146.71,155.19Zm8.48-8.48a77.86,77.86,0,0,0,12-19L222,182.52a66,66,0,0,1-11.35,19.69ZM30,96a66,66,0,1,1,66,66A66.08,66.08,0,0,1,30,96Zm65.49,78H96a77.84,77.84,0,0,0,19.13-2.38l53.77,53.76A65.87,65.87,0,0,1,95.49,174Z" }, null, -1)
      ]))) : a(n) === "regular" ? (o(), l("g", k, t[4] || (t[4] = [
