import { defineComponent as s, createElementBlock as o, openBlock as Z, mergeProps as M, unref as e, renderSlot as a, createCommentVNode as d, createElementVNode as l } from "vue";
import { useScalarIcon as C } from "../hooks/useScalarIcon.js";
const p = { key: 0 }, i = { key: 1 }, u = { key: 2 }, g = { key: 3 }, f = { key: 4 }, k = { key: 5 }, h = {
  name: "ScalarIconSpinnerBall"
}, _ = /* @__PURE__ */ s({
  ...h,
  props: {
    label: {},
  ...
  setup(c) {
    const A = c, { bind: m, weight: n } = C(A);
    return (r, t) => (Z(), o("svg", M({
      xmlns: "http://www.w3.org/2000/svg",
      viewBox: "0 0 256 256",
      fill: "currentColor"
    }, e(m)), [
      a(r.$slots, "default"),
      e(n) === "bold" ? (Z(), o("g", p, t[0] || (t[0] = [
        l("path", { d: "M128,20A108,108,0,1,0,236,128,108.12,108.12,0,0,0,128,20Zm83.65,100.47C188.51,136,170.71,133.74,151.92,126c7.87-6,15.29-12.73,21.35-21.16A74.85,74.85,0,0,0,187,68.25,83.73,83.73,0,0,1,211.65,120.47ZM163.3,51.8c1.9,27.81-9,42.09-25.09,54.48-1.24-9.82-3.38-19.61-7.64-29.08A75,75,0,0,0,105.69,47,83.73,83.73,0,0,1,163.3,51.8ZM79.69,59.35c25,12.25,31.93,28.8,34.6,48.94-9.12-3.82-18.66-6.87-29-7.91a75,75,0,0,0-38.59,6.46A84.2,84.2,0,0,1,79.69,59.35ZM44.35,135.53C67.49,120,85.29,122.26,104.08,130c-7.87,6-15.29,12.73-21.35,21.16A74.85,74.85,0,0,0,69,187.75,83.73,83.73,0,0,1,44.35,135.53ZM92.7,204.2c-1.9-27.81,9-42.09,25.09-54.48,1.24,9.82,3.38,19.61,7.64,29.08A75,75,0,0,0,150.31,209,83.73,83.73,0,0,1,92.7,204.2Zm83.61-7.55c-25-12.25-31.93-28.8-34.6-48.94,9.12,3.82,18.66,6.87,29,7.91q3.75.38,7.47.38a76,76,0,0,0,31.12-6.85A84.19,84.19,0,0,1,176.31,196.65Z" }, null, -1)
      ]))) : e(n) === "duotone" ? (Z(), o("g", i, t[1] || (t[1] = [
        l("path", {
      ...
      ]))) : e(n) === "thin" ? (Z(), o("g", k, t[5] || (t[5] = [
        l("path", { d: "M128,28A100,100,0,1,0,228,128,100.11,100.11,0,0,0,128,28Zm91.92,96.44c-33.69,24.71-58.55,15.45-83.94,3,23.54-15.86,45.85-33.95,43.34-75.81A92,92,0,0,1,219.92,124.44ZM170.86,46.61C175.4,88.13,155,105,131.55,120.83c-2-28.32-6.47-56.69-44-75.45a91.87,91.87,0,0,1,83.3,1.23ZM79,50.18c38.22,16.83,42.63,43,44.58,71.16-25.5-12.46-52.33-22.75-87.34.38A92.07,92.07,0,0,1,79,50.18Zm-42.9,81.38c33.69-24.71,58.55-15.45,83.94-3.05-23.54,15.86-45.85,34-43.34,75.81A92,92,0,0,1,36.08,131.56Zm49.06,77.83C80.6,167.87,101,151,124.45,135.17c2,28.32,6.47,56.69,44,75.45a91.87,91.87,0,0,1-83.3-1.23ZM177,205.82c-38.22-16.83-42.63-43-44.58-71.16,14.43,7.05,29.29,13.41,45.81,13.41,12.67,0,26.33-3.74,41.53-13.78A92.06,92.06,0,0,1,177,205.82Z" }, null, -1)
      ]))) : d("", !0)
    ], 16));
  }
});
