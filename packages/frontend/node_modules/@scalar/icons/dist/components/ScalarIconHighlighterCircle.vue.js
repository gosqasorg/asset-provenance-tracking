import { defineComponent as d, createElementBlock as a, openBlock as l, mergeProps as v, unref as o, renderSlot as i, createCommentVNode as m, createElementVNode as e } from "vue";
import { useScalarIcon as p } from "../hooks/useScalarIcon.js";
const h = { key: 0 }, u = { key: 1 }, A = { key: 2 }, g = { key: 3 }, M = { key: 4 }, f = { key: 5 }, H = {
  ...
  setup(r) {
    const s = r, { bind: V, weight: n } = p(s);
    return (Z, t) => (l(), a("svg", v({
      xmlns: "http://www.w3.org/2000/svg",
      viewBox: "0 0 256 256",
      fill: "currentColor"
    }, o(V)), [
      i(Z.$slots, "default"),
      o(n) === "bold" ? (l(), a("g", h, t[0] || (t[0] = [
      ...
      ]))) : o(n) === "fill" ? (l(), a("g", A, t[2] || (t[2] = [
        e("path", { d: "M201.54,54.46A104,104,0,0,0,54.46,201.54,104,104,0,0,0,201.54,54.46ZM96,210V152h64v58a88.33,88.33,0,0,1-64,0Zm94.22-19.78A88.09,88.09,0,0,1,176,201.77V152a16,16,0,0,0-16-16V72a8,8,0,0,0-11.58-7.16l-48,24A8,8,0,0,0,96,96v40a16,16,0,0,0-16,16v49.77a88,88,0,1,1,110.22-11.55Z" }, null, -1)
