import { defineComponent as m, createElementBlock as l, openBlock as t, mergeProps as v, unref as A, renderSlot as d, createCommentVNode as V, createElementVNode as o } from "vue";
import { useScalarIcon as p } from "../hooks/useScalarIcon.js";
const i = { key: 0 }, u = { key: 1 }, q = { key: 2 }, M = { key: 3 }, g = { key: 4 }, h = { key: 5 }, c = {
  name: "ScalarIconFarm"
}, H = /* @__PURE__ */ m({
  ...c,
  props: {
  ...
  setup(n) {
    const Z = n, { bind: r, weight: e } = p(Z);
    return (s, a) => (t(), l("svg", v({
      ...
      A(e) === "bold" ? (t(), l("g", i, a[0] || (a[0] = [
        o("path", { d: "M177.17,207.11A12,12,0,1,1,161,224.88,203.53,203.53,0,0,0,24,172a12,12,0,0,1,0-24A227.45,227.45,0,0,1,177.17,207.11Zm-74.74-2A186.47,186.47,0,0,0,24,188a12,12,0,0,0,0,24,162.61,162.61,0,0,1,68.41,14.9,12,12,0,1,0,10-21.81ZM244,160a12,12,0,0,1-12,12,205.19,205.19,0,0,0-31.38,2.4,270,270,0,0,1,32.59,34.09,12,12,0,1,1-18.72,15A243,243,0,0,0,24,132a12,12,0,0,1,0-24,271,271,0,0,1,44,3.6V80a12,12,0,0,1,4.8-9.6l64-48a12,12,0,0,1,14.4,0l64,48A12,12,0,0,1,220,80v28.28c4-.17,8-.28,12-.28a12,12,0,0,1,0,24,242.85,242.85,0,0,0-74.42,11.55q9.28,5.35,18.15,11.46A228.59,228.59,0,0,1,232,148,12,12,0,0,1,244,160Zm-88-52H132v19.3q11.83-4.77,24-8.39Zm-64,8.69c5.39,1.4,10.72,3,16,4.72V96a12,12,0,0,1,12-12h48a12,12,0,0,1,12,12v17q8-1.56,16-2.65V86L144,47,92,86Z" }, null, -1)
      ]))) : A(e) === "duotone" ? (t(), l("g", u, a[1] || (a[1] = [
        o("path", {
