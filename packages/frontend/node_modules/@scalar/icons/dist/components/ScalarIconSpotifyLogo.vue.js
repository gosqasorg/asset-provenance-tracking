import { defineComponent as s, createElementBlock as o, openBlock as e, mergeProps as d, unref as a, renderSlot as p, createCommentVNode as i, createElementVNode as n } from "vue";
import { useScalarIcon as u } from "../hooks/useScalarIcon.js";
const g = { key: 0 }, f = { key: 1 }, k = { key: 2 }, y = { key: 3 }, h = { key: 4 }, w = { key: 5 }, M = {
  ...
  setup(m) {
    ...
    return (r, t) => (e(), o("svg", d({
      ...
      ]))) : a(l) === "thin" ? (e(), o("g", w, t[5] || (t[5] = [
        n("path", { d: "M128,28A100,100,0,1,0,228,128,100.11,100.11,0,0,0,128,28Zm0,192a92,92,0,1,1,92-92A92.1,92.1,0,0,1,128,220Zm27.54-52.13a4,4,0,0,1-5.41,1.67,46.73,46.73,0,0,0-44.26,0A4.07,4.07,0,0,1,104,170a4,4,0,0,1-1.87-7.54,55.39,55.39,0,0,1,51.74,0A4,4,0,0,1,155.54,167.87Zm32-56a4,4,0,0,1-5.41,1.65,114.67,114.67,0,0,0-108.24,0,4,4,0,0,1-3.76-7.06,122.65,122.65,0,0,1,115.76,0A4,4,0,0,1,187.53,111.87Zm-16,28a4,4,0,0,1-5.41,1.65,81,81,0,0,0-76.24,0,4,4,0,0,1-3.76-7.06,89,89,0,0,1,83.76,0A4,4,0,0,1,171.53,139.88Z" }, null, -1)
      ]))) : i("", !0)
    ], 16));
  }
});
