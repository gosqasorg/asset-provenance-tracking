import { defineComponent as s, createElementBlock as t, openBlock as l, mergeProps as A, unref as o, renderSlot as r, createCommentVNode as h, createElementVNode as e } from "vue";
import { useScalarIcon as M } from "../hooks/useScalarIcon.js";
const d = { key: 0 }, i = { key: 1 }, p = { key: 2 }, v = { key: 3 }, u = { key: 4 }, g = { key: 5 }, f = {
  ...
  setup(n) {
    const V = n, { bind: H, weight: Z } = M(V);
    return (m, a) => (l(), t("svg", A({
      xmlns: "http://www.w3.org/2000/svg",
      viewBox: "0 0 256 256",
      fill: "currentColor"
    }, o(H)), [
      r(m.$slots, "default"),
      o(Z) === "bold" ? (l(), t("g", d, a[0] || (a[0] = [
