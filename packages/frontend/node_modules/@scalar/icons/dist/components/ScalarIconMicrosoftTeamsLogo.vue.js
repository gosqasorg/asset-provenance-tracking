import { defineComponent as s, createElementBlock as t, openBlock as A, mergeProps as V, unref as H, renderSlot as m, createCommentVNode as r, createElementVNode as o } from "vue";
import { useScalarIcon as M } from "../hooks/useScalarIcon.js";
const v = { key: 0 }, d = { key: 1 }, i = { key: 2 }, p = { key: 3 }, u = { key: 4 }, g = { key: 5 }, f = {
  ...
  setup(e) {
    ...
    return (h, a) => (A(), t("svg", V({
      ...
      ]))) : H(Z) === "thin" ? (A(), t("g", g, a[5] || (a[5] = [
        o("path", { d: "M108,104a4,4,0,0,1-4,4H92v44a4,4,0,0,1-8,0V108H72a4,4,0,0,1,0-8h32A4,4,0,0,1,108,104ZM228,92.74V152a36,36,0,0,1-35.44,36,60,60,0,0,1-113.13,0H40a12,12,0,0,1-12-12V80A12,12,0,0,1,40,68h62.07a36,36,0,0,1,66.48-27.36,28,28,0,0,1,35,43.36h15.69A8.75,8.75,0,0,1,228,92.74ZM171.23,48.61A36,36,0,0,1,158.64,84H184a20,20,0,1,0-12.77-35.39ZM110.71,68H136a12,12,0,0,1,12,12v1.29A28,28,0,1,0,110.71,68ZM40,180h96a4,4,0,0,0,4-4V80a4,4,0,0,0-4-4H40a4,4,0,0,0-4,4v96A4,4,0,0,0,40,180Zm148-12V96a4,4,0,0,0-4-4H148v84a12,12,0,0,1-12,12H88a52,52,0,0,0,100-20Zm32-75.26a.74.74,0,0,0-.74-.74h-24a11.8,11.8,0,0,1,.7,4v72a60.23,60.23,0,0,1-1.18,11.86A28,28,0,0,0,220,152Z" }, null, -1)
      ]))) : r("", !0)
    ], 16));
  }
});
