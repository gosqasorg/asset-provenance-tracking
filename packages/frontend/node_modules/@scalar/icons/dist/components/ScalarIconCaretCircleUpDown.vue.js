import { defineComponent as d, createElementBlock as a, openBlock as t, mergeProps as p, unref as o, renderSlot as A, createCommentVNode as i, createElementVNode as e } from "vue";
import { useScalarIcon as u } from "../hooks/useScalarIcon.js";
const g = { key: 0 }, L = { key: 1 }, M = { key: 2 }, f = { key: 3 }, k = { key: 4 }, w = { key: 5 }, h = {
  ...
  setup(r) {
    ...
    return (Z, l) => (t(), a("svg", p({
      ...
      o(n) === "bold" ? (t(), a("g", g, l[0] || (l[0] = [
        e("path", { d: "M128,20A108,108,0,1,0,236,128,108.12,108.12,0,0,0,128,20Zm0,192a84,84,0,1,1,84-84A84.09,84.09,0,0,1,128,212ZM168.49,95.51a12,12,0,0,1-17,17L128,89l-23.51,23.52a12,12,0,0,1-17-17l32-32a12,12,0,0,1,17,0Zm0,48a12,12,0,0,1,0,17l-32,32a12,12,0,0,1-17,0l-32-32a12,12,0,0,1,17-17L128,167l23.51-23.52A12,12,0,0,1,168.49,143.51Z" }, null, -1)
