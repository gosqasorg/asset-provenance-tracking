import { defineComponent as l, createElementBlock as H, openBlock as Z, mergeProps as n, unref as V, renderSlot as v, createCommentVNode as M, createElementVNode as t } from "vue";
import { useScalarIcon as r } from "../hooks/useScalarIcon.js";
const s = { key: 0 }, d = { key: 1 }, i = { key: 2 }, p = { key: 3 }, u = { key: 4 }, g = { key: 5 }, f = {
  ...
  setup(o) {
    const m = o, { bind: e, weight: A } = r(m);
    return (h, a) => (Z(), H("svg", n({
      xmlns: "http://www.w3.org/2000/svg",
      viewBox: "0 0 256 256",
      fill: "currentColor"
    }, V(e)), [
      v(h.$slots, "default"),
      V(A) === "bold" ? (Z(), H("g", s, a[0] || (a[0] = [
