import { defineComponent as s, createElementBlock as l, openBlock as t, mergeProps as d, unref as H, renderSlot as Z, createCommentVNode as V, createElementVNode as o } from "vue";
import { useScalarIcon as p } from "../hooks/useScalarIcon.js";
const m = { key: 0 }, i = { key: 1 }, u = { key: 2 }, M = { key: 3 }, v = { key: 4 }, g = { key: 5 }, h = {
  ...
  setup(n) {
    ...
    return (A, a) => (t(), l("svg", d({
      ...
      ]))) : H(e) === "thin" ? (t(), l("g", g, a[5] || (a[5] = [
        o("path", { d: "M227.9,144.24a20.45,20.45,0,0,0-17.84-3.53L160.75,152A23.76,23.76,0,0,0,164,140a24,24,0,0,0-24-24H89.94a27.81,27.81,0,0,0-19.8,8.2L46.34,148H16A12,12,0,0,0,4,160v40a12,12,0,0,0,12,12H120a4,4,0,0,0,1-.12l64-16a4.69,4.69,0,0,0,.6-.2l38.82-16.54.22-.1a20.6,20.6,0,0,0,3.29-34.8ZM12,200V160a4,4,0,0,1,4-4H44v48H16A4,4,0,0,1,12,200Zm209.13-28.17L182.72,188.2,119.51,204H52V153.66l23.8-23.8A19.86,19.86,0,0,1,89.94,124H140a16,16,0,0,1,0,32H112a4,4,0,0,0,0,8h32a3.94,3.94,0,0,0,.9-.1l67-15.41.16,0a12.6,12.6,0,0,1,9,23.38Zm-64-113a4,4,0,0,1,0-5.66l32-32a4,4,0,0,1,5.66,0l32,32a4,4,0,0,1-5.66,5.66L196,33.66V104a4,4,0,0,1-8,0V33.66L162.83,58.83A4,4,0,0,1,157.17,58.83Z" }, null, -1)
      ]))) : V("", !0)
    ], 16));
  }
});
