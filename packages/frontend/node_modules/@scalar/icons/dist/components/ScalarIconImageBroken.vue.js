import { defineComponent as Z, createElementBlock as a, openBlock as t, mergeProps as s, unref as o, renderSlot as L, createCommentVNode as d, createElementVNode as e } from "vue";
import { useScalarIcon as M } from "../hooks/useScalarIcon.js";
const m = { key: 0 }, p = { key: 1 }, i = { key: 2 }, u = { key: 3 }, g = { key: 4 }, h = { key: 5 }, f = {
  ...
  setup(A) {
    const V = A, { bind: H, weight: n } = M(V);
    return (r, l) => (t(), a("svg", s({
