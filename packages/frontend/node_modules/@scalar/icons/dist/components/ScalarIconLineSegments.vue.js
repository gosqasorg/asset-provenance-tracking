import { defineComponent as s, createElementBlock as l, openBlock as t, mergeProps as r, unref as o, renderSlot as d, createCommentVNode as i, createElementVNode as e } from "vue";
import { useScalarIcon as p } from "../hooks/useScalarIcon.js";
const u = { key: 0 }, g = { key: 1 }, L = { key: 2 }, M = { key: 3 }, c = { key: 4 }, f = { key: 5 }, k = {
  ...
  setup(h) {
    const m = h, { bind: A, weight: n } = p(m);
    return (Z, a) => (t(), l("svg", r({
      ...
      o(n) === "bold" ? (t(), l("g", u, a[0] || (a[0] = [
        e("path", { d: "M241.47,30.53a36,36,0,0,0-50.92,0h0a36.06,36.06,0,0,0-1.2,49.66l-23.83,44.26a36.08,36.08,0,0,0-21,3.07l-16-16a36,36,0,0,0-57.94-41h0a36,36,0,0,0-1.2,49.66L45.5,164.45a36,36,0,0,0-31,10.1h0a36,36,0,1,0,52.12,1.26l23.83-44.26A35.21,35.21,0,0,0,96,132a36.07,36.07,0,0,0,15.51-3.5l16,16a36,36,0,1,0,59.14-8.68L210.5,91.55A36.32,36.32,0,0,0,216,92a36,36,0,0,0,25.46-61.45Zm-154,57a12,12,0,0,1,17,17h0a12,12,0,0,1-17-17Zm-39,121a12,12,0,1,1,0-17A12,12,0,0,1,48.47,208.5Zm120-40a12,12,0,1,1,0-17A12,12,0,0,1,168.49,168.49Zm56-104a12,12,0,1,1,0-17A12,12,0,0,1,224.5,64.48Z" }, null, -1)
