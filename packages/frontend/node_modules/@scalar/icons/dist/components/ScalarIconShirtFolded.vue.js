import { defineComponent as L, createElementBlock as l, openBlock as t, mergeProps as r, unref as o, renderSlot as h, createCommentVNode as s, createElementVNode as V } from "vue";
import { useScalarIcon as M } from "../hooks/useScalarIcon.js";
const d = { key: 0 }, i = { key: 1 }, m = { key: 2 }, p = { key: 3 }, u = { key: 4 }, g = { key: 5 }, f = {
  ...
  setup(H) {
    ...
    return (Z, a) => (t(), l("svg", r({
      ...
      o(e) === "bold" ? (t(), l("g", d, a[0] || (a[0] = [
        ...
        V("path", { d: "M200,44H177.66L162.83,29.17h0A4,4,0,0,0,160,28H96a4,4,0,0,0-2.83,1.17h0L78.34,44H56A12,12,0,0,0,44,56V208a12,12,0,0,0,12,12H200a12,12,0,0,0,12-12V56A12,12,0,0,0,200,44ZM128,72.79,103.47,36h49.06Zm32.62-34.51L172,49.66V104a4,4,0,0,1-2.3,3.63,3.93,3.93,0,0,1-4.21-.51l-32.2-27.82ZM84,49.66,95.38,38.28l27.33,41-32.17,27.8A4,4,0,0,1,84,104ZM52,208V56a4,4,0,0,1,4-4H76v52a11.89,11.89,0,0,0,6.91,10.87A12.08,12.08,0,0,0,88,116a11.88,11.88,0,0,0,7.65-2.8l.06,0L124,88.74V212H56A4,4,0,0,1,52,208Zm152,0a4,4,0,0,1-4,4H132V88.74l28.32,24.46A11.9,11.9,0,0,0,168,116a12.08,12.08,0,0,0,5.12-1.15A11.89,11.89,0,0,0,180,104V52h20a4,4,0,0,1,4,4Z" }, null, -1)
      ]))) : s("", !0)
    ], 16));
  }
});
