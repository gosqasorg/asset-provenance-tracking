import { defineComponent as s, createElementBlock as a, openBlock as t, mergeProps as V, unref as o, renderSlot as Z, createCommentVNode as d, createElementVNode as H } from "vue";
import { useScalarIcon as i } from "../hooks/useScalarIcon.js";
const p = { key: 0 }, M = { key: 1 }, u = { key: 2 }, m = { key: 3 }, g = { key: 4 }, v = { key: 5 }, f = {
  ...
  setup(h) {
    const n = h, { bind: A, weight: e } = i(n);
    return (r, l) => (t(), a("svg", V({
      ...
      ]))) : o(e) === "light" ? (t(), a("g", m, l[3] || (l[3] = [
        H("path", { d: "M227.47,72A14,14,0,0,0,216,66H134V30h18a6,6,0,0,0,0-12H104a6,6,0,0,0,0,12h18V66H40A14,14,0,0,0,26.84,84.78l26.19,72A14,14,0,0,0,66.18,166H98v66a6,6,0,0,0,12,0V166h36v66a6,6,0,0,0,12,0V166h31.82A14,14,0,0,0,203,156.78l26.19-72A14,14,0,0,0,227.47,72ZM109,154,95.19,78h65.62L147,154ZM64.3,152.68l-26.18-72a2,2,0,0,1,.24-1.83A1.94,1.94,0,0,1,40,78H83l13.82,76H66.18A2,2,0,0,1,64.3,152.68Zm153.58-72-26.18,72a2,2,0,0,1-1.88,1.32H159.19L173,78h43a1.94,1.94,0,0,1,1.64.85A2,2,0,0,1,217.88,80.68Z" }, null, -1)
      ]))) : o(e) === "regular" ? (t(), a("g", g, l[4] || (l[4] = [
        H("path", { d: "M229.11,70.82A16,16,0,0,0,216,64H136V32h16a8,8,0,0,0,0-16H104a8,8,0,0,0,0,16h16V64H40A16,16,0,0,0,25,85.47l26.19,72a16,16,0,0,0,15,10.53H96v64a8,8,0,0,0,16,0V168h32v64a8,8,0,0,0,16,0V168h29.82a16,16,0,0,0,15-10.53l26.19-72A16,16,0,0,0,229.11,70.82ZM110.68,152,97.58,80h60.84l-13.1,72ZM40,80H81.32l13.09,72H66.18Zm149.82,72H161.59l13.09-72H216Z" }, null, -1)
      ]))) : o(e) === "thin" ? (t(), a("g", v, l[5] || (l[5] = [
        H("path", { d: "M225.83,73.11A12,12,0,0,0,216,68H132V28h20a4,4,0,0,0,0-8H104a4,4,0,0,0,0,8h20V68H40A12,12,0,0,0,28.72,84.1l26.19,72A12,12,0,0,0,66.18,164H100v68a4,4,0,0,0,8,0V164h40v68a4,4,0,0,0,8,0V164h33.82a12,12,0,0,0,11.27-7.9l26.19-72A12,12,0,0,0,225.83,73.11ZM107.34,156,92.79,76h70.42l-14.55,80Zm-44.92-2.63-26.18-72A4,4,0,0,1,40,76H84.66L99.2,156h-33A4,4,0,0,1,62.42,153.37Zm157.34-72-26.18,72a4,4,0,0,1-3.76,2.63h-33l14.55-80H216a4,4,0,0,1,3.76,5.37Z" }, null, -1)
      ]))) : d("", !0)
    ], 16));
  }
});
