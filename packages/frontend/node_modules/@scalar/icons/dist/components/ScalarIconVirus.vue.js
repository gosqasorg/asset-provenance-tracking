import { defineComponent as s, createElementBlock as l, openBlock as A, mergeProps as V, unref as t, renderSlot as H, createCommentVNode as d, createElementVNode as o } from "vue";
import { useScalarIcon as i } from "../hooks/useScalarIcon.js";
const p = { key: 0 }, u = { key: 1 }, L = { key: 2 }, g = { key: 3 }, M = { key: 4 }, f = { key: 5 }, k = {
  name: "ScalarIconVirus"
}, y = /* @__PURE__ */ s({
  ...k,
  props: {
    label: {},
  ...
  setup(n) {
    const m = n, { bind: Z, weight: e } = i(m);
    return (r, a) => (A(), l("svg", V({
