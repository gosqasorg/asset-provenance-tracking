import { defineComponent as d, createElementBlock as l, openBlock as t, mergeProps as M, unref as o, renderSlot as i, createCommentVNode as p, createElementVNode as e } from "vue";
import { useScalarIcon as u } from "../hooks/useScalarIcon.js";
const g = { key: 0 }, A = { key: 1 }, L = { key: 2 }, f = { key: 3 }, k = { key: 4 }, y = { key: 5 }, h = {
  ...
  setup(Z) {
    ...
    return (s, a) => (t(), l("svg", M({
      ...
      o(n) === "bold" ? (t(), l("g", g, a[0] || (a[0] = [
        ...
        e("path", { d: "M128,24A104,104,0,1,0,232,128,104.11,104.11,0,0,0,128,24ZM96,128a32,32,0,1,1,32,32A32,32,0,0,1,96,128Zm88.28-67.6L155.79,88.9a47.84,47.84,0,0,0-55.58,0L71.72,60.4a87.83,87.83,0,0,1,112.56,0ZM71.72,195.6l28.49-28.5a47.84,47.84,0,0,0,55.58,0l28.49,28.5a87.83,87.83,0,0,1-112.56,0Z" }, null, -1)
