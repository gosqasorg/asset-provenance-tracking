import { defineComponent as s, createElementBlock as a, openBlock as L, mergeProps as d, unref as t, renderSlot as p, createCommentVNode as i, createElementVNode as o } from "vue";
...
const M = { key: 0 }, g = { key: 1 }, f = { key: 2 }, k = { key: 3 }, A = { key: 4 }, h = { key: 5 }, w = {
  ...
  setup(e) {
    const m = e, { bind: n, weight: Z } = u(m);
    return (r, l) => (L(), a("svg", d({
      xmlns: "http://www.w3.org/2000/svg",
      viewBox: "0 0 256 256",
      fill: "currentColor"
    }, t(n)), [
      p(r.$slots, "default"),
      t(Z) === "bold" ? (L(), a("g", M, l[0] || (l[0] = [
        o("path", { d: "M238.83,146.13,201.08,120l37.75-26.13a12,12,0,0,0,0-19.74l-52-36a12,12,0,0,0-13.66,0L128,69.41,82.83,38.13a12,12,0,0,0-13.66,0l-52,36a12,12,0,0,0,0,19.74L54.92,120,17.17,146.13a12,12,0,0,0,0,19.74l52,36a12,12,0,0,0,13.66,0L128,170.59l45.17,31.28a12,12,0,0,0,13.66,0l52-36a12,12,0,0,0,0-19.74ZM128,141.41,97.08,120,128,98.59,158.92,120ZM180,62.6,210.92,84,180,105.4,149.08,84Zm-104,0L106.92,84,76,105.4,45.08,84Zm0,114.8L45.08,156,76,134.6,106.92,156Zm104,0L149.08,156,180,134.6,210.92,156Zm-25.27,32.09a12,12,0,0,1-3,16.7l-16.86,11.68a12,12,0,0,1-13.66,0l-16.86-11.68A12,12,0,1,1,118,206.46l10,6.94,10-6.94A12,12,0,0,1,154.73,209.49Z" }, null, -1)
      ]))) : t(Z) === "duotone" ? (L(), a("g", g, l[1] || (l[1] = [
        o("path", {
