import { defineComponent as d, createElementBlock as l, openBlock as t, mergeProps as M, unref as A, renderSlot as i, createCommentVNode as p, createElementVNode as o } from "vue";
import { useScalarIcon as m } from "../hooks/useScalarIcon.js";
const u = { key: 0 }, V = { key: 1 }, g = { key: 2 }, f = { key: 3 }, v = { key: 4 }, h = { key: 5 }, k = {
  name: "ScalarIconUserCircleGear"
}, _ = /* @__PURE__ */ d({
  ...k,
  props: {
    label: {},
  ...
  setup(n) {
    ...
    return (Z, a) => (t(), l("svg", M({
      ...
      A(e) === "bold" ? (t(), l("g", u, a[0] || (a[0] = [
        o("path", { d: "M169.57,46.11a12,12,0,0,1,15.12-7.7L188,39.48V36a12,12,0,0,1,24,0v3.48l3.31-1.07a12,12,0,1,1,7.42,22.82l-3.31,1.08,2,2.82a12,12,0,1,1-19.41,14.1L200,76.42,198,79.23a12,12,0,1,1-19.41-14.1l2-2.82-3.31-1.08A12,12,0,0,1,169.57,46.11ZM236,128A108,108,0,1,1,128,20a109.19,109.19,0,0,1,18,1.49,12,12,0,0,1-4,23.67A85,85,0,0,0,128,44,83.94,83.94,0,0,0,62.05,179.94a83.48,83.48,0,0,1,29-23.42,52,52,0,1,1,74,0,83.48,83.48,0,0,1,29,23.42A83.57,83.57,0,0,0,212,128a85.2,85.2,0,0,0-1.16-14,12,12,0,0,1,23.67-4A109,109,0,0,1,236,128ZM128,148a28,28,0,1,0-28-28A28,28,0,0,0,128,148Zm0,64a83.53,83.53,0,0,0,48.43-15.43,60,60,0,0,0-96.86,0A83.53,83.53,0,0,0,128,212Z" }, null, -1)
      ]))) : A(e) === "duotone" ? (t(), l("g", V, a[1] || (a[1] = [
        o("path", {
