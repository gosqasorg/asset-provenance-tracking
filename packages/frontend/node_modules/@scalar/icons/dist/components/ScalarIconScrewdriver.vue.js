import { defineComponent as i, createElementBlock as l, openBlock as t, mergeProps as p, unref as o, renderSlot as u, createCommentVNode as L, createElementVNode as e } from "vue";
import { useScalarIcon as V } from "../hooks/useScalarIcon.js";
const h = { key: 0 }, m = { key: 1 }, H = { key: 2 }, Z = { key: 3 }, g = { key: 4 }, M = { key: 5 }, v = {
  name: "ScalarIconScrewdriver"
}, w = /* @__PURE__ */ i({
  ...v,
  props: {
    label: {},
  ...
  setup(A) {
    const r = A, { bind: s, weight: n } = V(r);
    return (d, a) => (t(), l("svg", p({
