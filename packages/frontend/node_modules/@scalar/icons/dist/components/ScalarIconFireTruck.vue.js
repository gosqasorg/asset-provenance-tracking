import { defineComponent as A, createElementBlock as H, openBlock as V, mergeProps as M, unref as t, renderSlot as m, createCommentVNode as r, createElementVNode as Z } from "vue";
import { useScalarIcon as s } from "../hooks/useScalarIcon.js";
const d = { key: 0 }, i = { key: 1 }, p = { key: 2 }, u = { key: 3 }, v = { key: 4 }, g = { key: 5 }, f = {
  ...
  setup(o) {
    const e = o, { bind: n, weight: l } = s(e);
    return (h, a) => (V(), H("svg", M({
      xmlns: "http://www.w3.org/2000/svg",
      viewBox: "0 0 256 256",
      fill: "currentColor"
    }, t(n)), [
      m(h.$slots, "default"),
      t(l) === "bold" ? (V(), H("g", d, a[0] || (a[0] = [
        Z("path", { d: "M255.14,115.54l-14-35A19.9,19.9,0,0,0,222.58,68H204V64a12,12,0,0,0-24,0v94.06A36.23,36.23,0,0,0,158.06,180H113.94a36,36,0,0,0-67.88,0H36V144a12,12,0,0,0-24,0v40a20,20,0,0,0,20,20H46.06a36,36,0,0,0,67.88,0h44.12a36,36,0,0,0,67.88,0H236a20,20,0,0,0,20-20V120A12,12,0,0,0,255.14,115.54ZM219.88,92l6.4,16H204V92ZM80,204a12,12,0,1,1,12-12A12,12,0,0,1,80,204Zm112,0a12,12,0,1,1,12-12A12,12,0,0,1,192,204Zm33.94-24A36.23,36.23,0,0,0,204,158.06V132h28v48ZM24,92a12,12,0,0,0,0,24H152a12,12,0,0,0,0-24H140V76h12a12,12,0,0,0,0-24H24a12,12,0,0,0,0,24H36V92Zm92,0H100V76h16ZM60,76H76V92H60Z" }, null, -1)
      ]))) : t(l) === "duotone" ? (V(), H("g", i, a[1] || (a[1] = [
        Z("path", {
