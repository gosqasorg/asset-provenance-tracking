import { defineComponent as c, createElementBlock as t, openBlock as l, mergeProps as H, unref as o, renderSlot as s, createCommentVNode as r, createElementVNode as e } from "vue";
import { useScalarIcon as d } from "../hooks/useScalarIcon.js";
const m = { key: 0 }, M = { key: 1 }, i = { key: 2 }, p = { key: 3 }, u = { key: 4 }, v = { key: 5 }, g = {
  name: "ScalarIconFileRs"
}, k = /* @__PURE__ */ c({
  ...g,
  props: {
    label: {},
  ...
  setup(A) {
    const V = A, { bind: h, weight: n } = d(V);
    return (Z, a) => (l(), t("svg", H({
