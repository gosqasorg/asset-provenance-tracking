...
const C = { key: 0 }, g = { key: 1 }, h = { key: 2 }, m = { key: 3 }, M = { key: 4 }, Z = { key: 5 }, f = {
  ...
  setup(c) {
    const r = c, { bind: s, weight: n } = H(r);
    return (A, a) => (t(), l("svg", p({
