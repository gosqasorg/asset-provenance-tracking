import { defineComponent as C, createElementBlock as a, openBlock as o, mergeProps as Z, unref as e, renderSlot as d, createCommentVNode as i, createElementVNode as l } from "vue";
import { useScalarIcon as p } from "../hooks/useScalarIcon.js";
const u = { key: 0 }, q = { key: 1 }, A = { key: 2 }, g = { key: 3 }, M = { key: 4 }, f = { key: 5 }, h = {
  name: "ScalarIconFishSimple"
}, y = /* @__PURE__ */ C({
  ...h,
  props: {
    label: {},
  ...
  setup(c) {
    ...
    return (m, t) => (o(), a("svg", Z({
      ...
      ]))) : e(n) === "thin" ? (o(), a("g", f, t[5] || (t[5] = [
        l("path", { d: "M164,76a8,8,0,1,1-8-8A8,8,0,0,1,164,76Zm42.77,76.73c-14.5,20-36.17,33.57-64.38,40.2-20.91,4.91-45.61,6-73.8,3.42q2.46,20.18,7.41,42.79a4,4,0,0,1-3,4.77,4.19,4.19,0,0,1-.86.09,4,4,0,0,1-3.9-3.14,457,457,0,0,1-7.72-45.36q-21.4-2.49-45.33-7.72A4,4,0,1,1,16.86,180q22.59,4.95,42.76,7.41c-2.62-28.16-1.48-52.84,3.43-73.73,6.63-28.21,20.14-49.88,40.18-64.39C127.32,31.8,156.61,28,177.53,28h1.71c22,.21,40.12,4.54,41.81,5.53A4,4,0,0,1,222.46,35c1,1.68,5.31,19.8,5.53,41.79C228.2,97.75,224.69,128,206.77,152.73Zm-12.23,2.43a108,108,0,0,1-93.7-93.7c-27.92,25.08-39,67.62-33.14,126.81C126.9,194.14,169.45,183.07,194.54,155.16Zm21.2-114.9C204.9,37.73,148.5,26.69,108.3,55.46a99.92,99.92,0,0,0,92.23,92.24C229.29,107.52,218.27,51.11,215.74,40.26Z" }, null, -1)
      ]))) : i("", !0)
    ], 16));
  }
});
