import { defineComponent as l, createElementBlock as V, openBlock as Z, mergeProps as r, unref as H, renderSlot as s, createCommentVNode as M, createElementVNode as t } from "vue";
import { useScalarIcon as d } from "../hooks/useScalarIcon.js";
const i = { key: 0 }, p = { key: 1 }, u = { key: 2 }, h = { key: 3 }, g = { key: 4 }, f = { key: 5 }, k = {
  name: "ScalarIconCity"
}, _ = /* @__PURE__ */ l({
  ...k,
  props: {
  ...
  setup(o) {
    const v = o, { bind: e, weight: m } = d(v);
    return (n, a) => (Z(), V("svg", r({
      xmlns: "http://www.w3.org/2000/svg",
      viewBox: "0 0 256 256",
      fill: "currentColor"
    }, H(e)), [
      s(n.$slots, "default"),
      H(m) === "bold" ? (Z(), V("g", i, a[0] || (a[0] = [
      ...
      ]))) : H(m) === "fill" ? (Z(), V("g", u, a[2] || (a[2] = [
        t("path", { d: "M240,208h-8V88a8,8,0,0,0-8-8H160a8,8,0,0,0-8,8v40H104V40a8,8,0,0,0-8-8H32a8,8,0,0,0-8,8V208H16a8,8,0,0,0,0,16H240a8,8,0,0,0,0-16ZM72,184a8,8,0,0,1-16,0V168a8,8,0,0,1,16,0Zm0-48a8,8,0,0,1-16,0V120a8,8,0,0,1,16,0Zm0-48a8,8,0,0,1-16,0V72a8,8,0,0,1,16,0Zm64,96a8,8,0,0,1-16,0V168a8,8,0,0,1,16,0Zm64,0a8,8,0,0,1-16,0V168a8,8,0,0,1,16,0Zm0-48a8,8,0,0,1-16,0V120a8,8,0,0,1,16,0Z" }, null, -1)
      ]))) : H(m) === "light" ? (Z(), V("g", h, a[3] || (a[3] = [
      ...
      ]))) : H(m) === "regular" ? (Z(), V("g", g, a[4] || (a[4] = [
        t("path", { d: "M240,208h-8V88a8,8,0,0,0-8-8H160a8,8,0,0,0-8,8v40H104V40a8,8,0,0,0-8-8H32a8,8,0,0,0-8,8V208H16a8,8,0,0,0,0,16H240a8,8,0,0,0,0-16ZM168,96h48V208H168Zm-16,48v64H104V144ZM40,48H88V208H40ZM72,72V88a8,8,0,0,1-16,0V72a8,8,0,0,1,16,0Zm0,48v16a8,8,0,0,1-16,0V120a8,8,0,0,1,16,0Zm0,48v16a8,8,0,0,1-16,0V168a8,8,0,0,1,16,0Zm48,16V168a8,8,0,0,1,16,0v16a8,8,0,0,1-16,0Zm64,0V168a8,8,0,0,1,16,0v16a8,8,0,0,1-16,0Zm0-48V120a8,8,0,0,1,16,0v16a8,8,0,0,1-16,0Z" }, null, -1)
      ]))) : H(m) === "thin" ? (Z(), V("g", f, a[5] || (a[5] = [
