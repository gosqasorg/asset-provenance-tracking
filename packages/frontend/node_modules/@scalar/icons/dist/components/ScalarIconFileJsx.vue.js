import { defineComponent as V, createElementBlock as l, openBlock as t, mergeProps as r, unref as o, renderSlot as L, createCommentVNode as m, createElementVNode as e } from "vue";
import { useScalarIcon as d } from "../hooks/useScalarIcon.js";
const v = { key: 0 }, i = { key: 1 }, p = { key: 2 }, M = { key: 3 }, u = { key: 4 }, g = { key: 5 }, h = {
  name: "ScalarIconFileJsx"
}, f = /* @__PURE__ */ V({
  ...h,
  props: {
    label: {},
  ...
  setup(c) {
    const Z = c, { bind: A, weight: n } = d(Z);
    return (s, a) => (t(), l("svg", r({
      xmlns: "http://www.w3.org/2000/svg",
      viewBox: "0 0 256 256",
      fill: "currentColor"
    }, o(A)), [
      L(s.$slots, "default"),
      o(n) === "bold" ? (t(), l("g", v, a[0] || (a[0] = [
      ...
      ]))) : o(n) === "thin" ? (t(), l("g", g, a[5] || (a[5] = [
        e("path", { d: "M143.84,195.8a17,17,0,0,1-7.43,12.41c-4.39,2.91-10,3.77-15.22,3.77A57.89,57.89,0,0,1,107,210.11a4,4,0,1,1,2.15-7.7c4.22,1.17,16.56,3.29,22.83-.88a8.94,8.94,0,0,0,3.91-6.75c.83-6.45-4.38-8.69-15.64-11.94-9.68-2.8-21.72-6.28-20.14-18.77a16.66,16.66,0,0,1,7.22-12.13c4.56-3.07,11-4.36,19.1-3.82a61.33,61.33,0,0,1,10.48,1.61,4,4,0,0,1-2.05,7.74c-4.29-1.13-16.81-3.12-23.06,1.11a8.51,8.51,0,0,0-3.75,6.49c-.66,5.17,3.89,7,14.42,10.08C132.26,178,145.64,181.84,143.84,195.8ZM72,148a4,4,0,0,0-4,4v38a14,14,0,0,1-28,0,4,4,0,0,0-8,0,22,22,0,0,0,44,0V152A4,4,0,0,0,72,148Zm138.32.75a4,4,0,0,0-5.58.92L188,173.12l-16.75-23.45a4,4,0,0,0-6.51,4.66L183.08,180l-18.34,25.67a4,4,0,0,0,.93,5.58,4,4,0,0,0,5.58-.92L188,186.88l16.74,23.45A4,4,0,0,0,208,212a3.91,3.91,0,0,0,2.32-.75,4,4,0,0,0,.93-5.58L192.92,180l18.33-25.67A4,4,0,0,0,210.32,148.75ZM212,88v24a4,4,0,0,1-8,0V92H152a4,4,0,0,1-4-4V36H56a4,4,0,0,0-4,4v72a4,4,0,0,1-8,0V40A12,12,0,0,1,56,28h96a4,4,0,0,1,2.83,1.17l56,56A4,4,0,0,1,212,88Zm-13.66-4L156,41.65V84Z" }, null, -1)
      ]))) : m("", !0)
    ], 16));
  }
});
