import { defineComponent as v, createElementBlock as t, openBlock as l, mergeProps as L, unref as o, renderSlot as H, createCommentVNode as d, createElementVNode as e } from "vue";
import { useScalarIcon as M } from "../hooks/useScalarIcon.js";
const p = { key: 0 }, A = { key: 1 }, m = { key: 2 }, i = { key: 3 }, u = { key: 4 }, g = { key: 5 }, f = {
  ...
  setup(V) {
    const Z = V, { bind: r, weight: n } = M(Z);
    return (s, a) => (l(), t("svg", L({
