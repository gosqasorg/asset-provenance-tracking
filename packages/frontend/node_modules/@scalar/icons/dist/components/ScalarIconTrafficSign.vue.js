import { defineComponent as h, createElementBlock as t, openBlock as l, mergeProps as m, unref as o, renderSlot as i, createCommentVNode as p, createElementVNode as L } from "vue";
import { useScalarIcon as u } from "../hooks/useScalarIcon.js";
const Z = { key: 0 }, g = { key: 1 }, v = { key: 2 }, f = { key: 3 }, k = { key: 4 }, M = { key: 5 }, w = {
  ...
  setup(n) {
    ...
    return (d, a) => (l(), t("svg", m({
      ...
      i(d.$slots, "default"),
      o(e) === "bold" ? (l(), t("g", Z, a[0] || (a[0] = [
        L("path", { d: "M246,113.46,142.54,10a20.57,20.57,0,0,0-29.08,0L10,113.46a20.57,20.57,0,0,0,0,29.08L113.46,246h0a20.57,20.57,0,0,0,29.08,0L246,142.54a20.57,20.57,0,0,0,0-29.08ZM128,226.57,29.43,128,128,29.43,226.57,128Zm7.51-122.08a12,12,0,0,1,17-17l24,24a12,12,0,0,1,0,17l-24,24a12,12,0,0,1-17-17L139,132H112a12,12,0,0,0-12,12v4a12,12,0,0,1-24,0v-4a36,36,0,0,1,36-36h27Z" }, null, -1)
      ]))) : o(e) === "duotone" ? (l(), t("g", g, a[1] || (a[1] = [
        L("path", {
