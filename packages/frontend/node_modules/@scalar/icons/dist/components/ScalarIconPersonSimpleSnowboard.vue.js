import { defineComponent as s, createElementBlock as l, openBlock as t, mergeProps as d, unref as o, renderSlot as L, createCommentVNode as p, createElementVNode as e } from "vue";
import { useScalarIcon as i } from "../hooks/useScalarIcon.js";
const u = { key: 0 }, g = { key: 1 }, M = { key: 2 }, h = { key: 3 }, f = { key: 4 }, k = { key: 5 }, w = {
  ...
  setup(m) {
    ...
    return (Z, a) => (t(), l("svg", d({
      ...
      o(n) === "bold" ? (t(), l("g", u, a[0] || (a[0] = [
        e("path", { d: "M168,80a32,32,0,1,0-32-32A32,32,0,0,0,168,80Zm0-40a8,8,0,1,1-8,8A8,8,0,0,1,168,40Zm51.38,68.48-136-40a12,12,0,0,0-6.77,23L112.25,102l-28.64,43L44,133.27a30.79,30.79,0,0,0-27.38,4.94A31.18,31.18,0,0,0,4,163.39,31.53,31.53,0,0,0,26.43,193.5h0L180,238.71a31.23,31.23,0,0,0,40-30.11,31.52,31.52,0,0,0-22.44-30.11l-39.74-11.7L170,148.68a12,12,0,0,0-6.62-18.21l-34.56-10,7.58-11.38,76.25,22.43a12,12,0,1,0,6.77-23ZM196,208.6a7.36,7.36,0,0,1-3,6,6.92,6.92,0,0,1-6.23,1.13L33.21,170.48A7.46,7.46,0,0,1,31,157.42a7,7,0,0,1,6.23-1.13l153.59,45.22A7.39,7.39,0,0,1,196,208.6ZM140.88,149l-7.2,10.73-26-7.64,7.1-10.64Z" }, null, -1)
