...
export default class MultipartReader {
     ...
     */
        ...
        if (this.state !== MultiparParserStateEnum.data) {
            throw new this.window.DOMException(`Unexpected end of multipart stream. Expected state to be "${MultiparParserStateEnum.data}" but got "${this.state}".`, DOMExceptionNameEnum.invalidStateError);
        }
