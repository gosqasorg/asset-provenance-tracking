...
import { validateKey } from './keyFuncs';

describe('validateDeviceKey', () => {
    it('should return true when given a valid device key', async () => {
    ...
    it('should return false when given an invalid string', async () => {
    ...
    it('should return false when not given a string', async () => {
      // @ts-ignore
