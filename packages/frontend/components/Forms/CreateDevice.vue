...
<template>
  ...
  <form enctype="multipart/form-data" class="p-3" id="record-form" @submit.prevent="submitForm">
    ...
    <div>
      ...
      <div class="my-3">
        <h4>
          <input v-model="isChecked" type="checkbox" class="form-check-input" id="notify-all" /> I'm
          open to providing feedback on my experience with GDT
        </h4>
        <div v-if="isChecked">
