...
<template>
 ...
 <script lang="ts">
 import { postProvenance, getProvenance, displayOfflineBanner, displayOnlineBanner, postNotificationEmail, offlineDetectAndStash, offlineModeFeatureFlag, notifySubscribers } from '~/services/azureFuncs';
