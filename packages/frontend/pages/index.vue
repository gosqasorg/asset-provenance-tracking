...
<template>
    <div>
        <h1>GOSQAS Asset History Tracker</h1>
        <p>
            ...
            The GOSQAS Asset History Tracker allows anyone with access to an open source medical device to trace the provenance and add to it using a simple website. 
