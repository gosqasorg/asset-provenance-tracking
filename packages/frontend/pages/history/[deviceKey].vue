      ...
      <div class="row pt-3 pb-6 mx-4">
        ...
        <div class="col-md-10">
          ...
          >
            ...
            <OfflineBanner
              v-if="displayBanner"
              class="offline-banner-top"
              style="align-items: center; display: flex"
            >
              <div
                class="danger-symbol"
                style="justify-content: left; font-size: 27px; margin-left: -10px; color: #fe9c9e"
              >
                &#9888;
              </div>
              <div style="margin-left: 10px">
                <strong>You're offline:</strong> Connect to the internet to view the most recent
                version of this page. Your changes will not be posted until you revisit this page
                while online.
              </div>
            </OfflineBanner>
