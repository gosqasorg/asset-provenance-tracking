  ...
  <div v-if="!isLoading" class="gdt" id="gdt-container">
    <div class="container-md">
      ...
      <p class="my-4 mb-5 form-control">
        Global Distributed Tracking is a free, open source, and fully encrypted software solution
        enabling closed-loop tracking for products, information, and logistics.
      </p>
    </div>
  </div>
